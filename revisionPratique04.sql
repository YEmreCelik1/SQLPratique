--*****Tablodaki Data Nasil Update Edilir (DML-UPDATE SET)?*****
...
update urunler1 set urun_isim=(select firma_ismi from tedarikciler where irtibat_ismi='Adam Eve')
where musteri_isim='Ali Bak';

select * from urunler1;
select * from tedarikciler;

--Urunler tablosunda laptop satin alan musterilerin ismini, firma_ismi Apple olanlain irtibat_isim'i ile degistirin.
update urunler1 set musteri_isim=(select irtibat_ismi from tedarikciler where firma_ismi='Apple')
